...
while True:  
    ...
    while True:
        ...
        if my_hour==0 and my_minute>=0:   
            ...
            time.sleep(3) 
            my_params1=edit_y_params(today_date,order_morning1,order_morning2,order_morning3,order_morning4,dev_id[id1])
            my_params2=edit_y_params(today_date,order_afternoon1,order_afternoon2,order_afternoon3,order_afternoon4,dev_id[id1])
            ...
            if success_afternoon_flag and success_morning_flag:
                ...
                if flag%2==0:
                    id1+=1
                    print("The {}th seat failed to grab the seat, and the seat has been switched to the next seat to start grabbing!".format(id1))
        else:
